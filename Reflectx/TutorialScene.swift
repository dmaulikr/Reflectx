...
class TutorialScene: SKScene, SKPhysicsContactDelegate {
    ...
    func wave1() {
        ...
        let wavePositionsX = [40, 120, 200, 280, 120, 170]
        var index = 0
    ...
    func wave2() {
        ...
        self.runAction(SKAction.sequence([run, wait, run, wait, run, wait, finish]))
        
    }
    
    func wave3() { // work on this
